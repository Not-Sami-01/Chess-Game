      ...
      <footer className='footer bg-primary px-4 py-6 flex flex-col items-center'>
        <div className="credit flex flex-col items-center gap-2">
          ...
          <div className="flex gap-4 mt-1">
            <a href="https://github.com/samiulrehman" target="_blank" rel="noopener noreferrer" className="footer-icon-link" aria-label="GitHub">
              {/* GitHub SVG icon */}
            ...
            <a href="https://www.linkedin.com/in/samiulrehman/" target="_blank" rel="noopener noreferrer" className="footer-icon-link" aria-label="LinkedIn">
              {/* LinkedIn SVG icon */}
